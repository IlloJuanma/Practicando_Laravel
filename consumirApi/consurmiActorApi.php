...
<body>
<?php
    $apiUrl= "http://localhost:8000/api/actor";
    ...
    <?php foreach($actors as $actor){ ?>
        <hr>
        <p>Nombre: <?php echo $actor['first_name'] ?></p>
        <p>Apellido: <?php echo $actor['last_name'] ?></p>
        <p>Nacimiento: <?php echo $actor['date_of_birth'] ?></p>  
        <?php } ?>
